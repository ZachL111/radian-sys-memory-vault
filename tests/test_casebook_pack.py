"""Regression checks for the radian-sys-memory-vault casebook."""
...
from casebook.harness import assert_expected, radian_sys_memory_vault_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(radian_sys_memory_vault_summary(), assert_expected())
